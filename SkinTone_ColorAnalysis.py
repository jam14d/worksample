...
This script finds the average skin tone in an image, determines its complementary color, and then displaying the original image alongside a block of the complementary color.
'''

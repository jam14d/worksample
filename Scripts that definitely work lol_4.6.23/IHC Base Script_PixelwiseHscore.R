...
path.det = "C://Analysis_Studies//23-712 Treeline IHC CD10_qp//detection results"
path.ano = "C://Analysis_Studies//23-712 Treeline IHC CD10_qp//annotation results"
path.hist = "C://Analysis_Studies//23-712 Treeline IHC CD10_qp//histo"
setwd(path.det)
...
for(f in 1:length(filelist)){
  ...
  Negative_MeanIntensity <- mean(Negative$DAB..Cell..Mean)
  Low_MeanIntensity <- mean(Low$DAB..Cell..Mean)
  Medium_MeanIntensity <- mean(Medium$DAB..Cell..Mean)
  High_MeanIntensity <- mean(High$DAB..Cell..Mean)

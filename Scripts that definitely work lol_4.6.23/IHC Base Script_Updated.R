...
path.det = "D://23-159 Grace_spc_qp//detections_spc_10.12.23"
path.ano = "D://23-159 Grace_spc_qp//annotations_spc_10.12.23"
setwd(path.det)
...
for(f in 1:length(filelist)){
  ...
  #if IF stardist, use Positive$Green..Cell..Mean

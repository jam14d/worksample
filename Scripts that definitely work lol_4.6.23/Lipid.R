path.det="C://Analysis_Studies//22-623 UW Madison_train_qp//detections"
path.ano = "C://Analysis_Studies//22-623 UW Madison_train_qp//annotations"
setwd(path.det)
...
colnames(DataDraft) <- c("Sample", "% Lipid Area", "Total Lipid Area (mm^2)", "% Macrovesicular", "% Microvesicular", "Average Vesicle Size (um^2)", "Tissue Area Analyzed (mm^2)")
write.csv(DataDraft,paste("Area File_3",f,".csv"))

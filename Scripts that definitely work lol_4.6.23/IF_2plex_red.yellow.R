...
path.det = "C://Analysis_Studies//21-841 Ribon Polaris_qp//detection results_skinfinalhopefully"
path.ano = "C://Analysis_Studies//21-841 Ribon Polaris_qp//annotation results_skinfinalhopefully"
...
write.csv(DataDraft,paste("Cy5_TRITC_Data",f,".csv"), row.names = F)
write.xlsx(DataDraft, paste("Cy5_TRITC_Data_3",f,".xlsx"))

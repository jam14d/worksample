...
# Set the paths
path_det = "/Users/jamieannemortel/Downloads/rawdata_composite 2/detection_csv"
path_ano = "/Users/jamieannemortel/Downloads/rawdata_composite 2/annotation_csv"
...
for k, file in enumerate(filelist):
    try:
        ...
        pinkIntensity = QPpink_only['AF568: Cell: Mean'].mean() if not QPpink_only.empty else None
        blueIntensity = QPblue_only['AF568: Cell: Mean'].mean() if not QPblue_only.empty else None
        ...
        DataDraft.loc[k, "vglut2-: vgat+ _ oprm1 Intensity"] = blueIntensity
        ...
        DataDraft.loc[k, "vglut2+: vgat- _ oprm1 Intensity"] = pinkIntensity
        ...
        DataDraft.loc[k, "VP Annotation Area (mm^2)"] = anoArea

    except Exception as e:
        print(f"Error processing {file}: {e}")

# Write the results to a CSV and XLSX file
DataDraft.to_csv("oprm1_processed_data_VP.csv", index=False)
DataDraft.to_excel("oprm1_processed_data_VP.xlsx", index=False)
